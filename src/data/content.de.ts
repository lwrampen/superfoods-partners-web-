...
export const PRODUCTS_DE: Record<string, ProductText> = {
  "matcha": {
    ...
    "intro": "Matcha ist steingemahlener Grüntee, der vor der Ernte wochenlang beschattet wird, um sein tiefes Umami und die leuchtende Farbe aufzubauen. Wir liefern Single-Origin-Matcha aus Japan und China in Ceremonial-, Premium- und Culinary-Graden — schattengezogen, steingemahlen und in jeder Charge laborgeprüft, von der Probe bis zum ganzen Container.",
    "applications": [
      "Lattes & Matcha-Bars",
  ...
  "jasmine-tea-powder": {
    ...
    "intro": "Jasmin-Teepulver ist Grüntee, der mit echter Jasminblüte geschichtet und dann fein gemahlen wird — für ein florales Aroma und einen klaren, weichen Abgang. Wir beziehen ihn aus Ostchina und Fujian — Chinas klassischer Jasmin-Region — und prüfen und dokumentieren jede Charge, bevor sie versendet wird.",
    "applications": [
      "Lattes & Tea-Bars",
      "RTD & abgefüllte Getränke",
      "Backwaren & Patisserie",
  ...
  "oolong-tea-powder": {
    ...
    "intro": "Oolong ist halbfermentierter Tee — zwischen Grün und Schwarz — mit einer röstigen, floralen Komplexität. Wir mahlen Ganzblatt-Oolong aus Chinas klassischem Oolong-Land zu einem feinen Pulver für Spezialitäten-Lattes, RTD und Dessert-Arbeit, pro Charge geprüft und dokumentiert, bevor es versendet wird.",
    "applications": [
  ...
  "earl-grey-tea-powder": {
    ...
    "intro": "Earl Grey ist Schwarztee mit natürlicher Bergamotte — kräftig, zitrushell und sofort erkennbar. Wir mahlen ihn zu einem feinen Pulver, das sein Aroma durch Lattes, Backwaren und Getränkeinnovation trägt, bezogen aus Ostchina und Fujian und pro Charge dokumentiert, bevor es versendet wird.",
    "applications": [
      "Lattes & Tea-Bars",
      "RTD & abgefüllte Getränke",
      "Backwaren & Patisserie",
...
export const ORIGIN_INTRO_DE: Record<string, string> = {
  "china-cn": "Über Tee hinaus ist China einer der weltweit größten und leistungsfähigsten Anbauer funktioneller und spezieller Kulturen — von Lion's Mane und anderen Pilzen bis zu Ube und botanischen Pulvern. Wir arbeiten für diese Linien mit geprüfter chinesischer Versorgung, testen jede Charge auf Pestizidrückstände, Schwermetalle und Mikrobiologie und dokumentieren sie mit einem Verification Record™, bevor sie versendet wird. Es ist die Route, zu der wir greifen, wenn ein Programm echte Skalierung braucht, ohne die Rückverfolgbarkeit zu verlieren.",
  "egypt-eg": "Ägyptens vom Nil gespeiste Felder sind die klassische Heimat des Hibiskus (Hibiscus sabdariffa). Lange Sonnenstunden geben den Kelchen ihre tiefe Rubinfarbe und ihre helle, klare Säure. Wir beziehen sonnengereiften ägyptischen Hibiskus, mahlen ihn zu einem gleichmäßigen Pulver und testen jede Charge auf Kontaminanten und dokumentieren sie, bevor sie versendet wird — sodass die Farbe und Säure, die Sie bemustern, auch die Farbe und Säure sind, die Sie im Volumen erhalten."
};
