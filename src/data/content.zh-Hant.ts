...
export const PRODUCTS_ZH: Record<string, ProductText> = {
  "matcha": {
    ...
    "intro": "抹茶是一種石臼研磨的綠茶,採收前遮蔭數週,以孕育深厚的鮮味與鮮亮的色澤。我們供應來自日本與中國的單一產地抹茶,分儀式級、premium 與料理級——遮蔭栽培、石臼研磨,並逐批經實驗室檢測,自樣品至整櫃。",
    "applications": [
      "拿鐵與抹茶吧",
      "即飲與瓶裝飲品",
      "烘焙與甜點",
  ...
  "hojicha": {
    ...
    "intro": "焙茶是以炭火烘焙的日本綠茶,烘焙使咖啡因變得溫和,並帶出溫暖的焙香。我們供應焙茶粉,研磨至色澤與風味一致——適合拿鐵、烘焙與即飲——採購自日本與華東,並於出貨前逐批記錄。",
    "applications": [
      "拿鐵與焙茶吧",
      "即飲與瓶裝飲品",
      "烘焙與甜點",
  ...
  "ube": {
    ...
    "intro": "Ube 是紫山藥的塊莖,呈濃郁紫色,已從菲律賓廚房走上世界各地的菜單。我們的紫山藥粉以成熟的紫山藥(Dioscorea alata)研磨而成——呈現純淨、天然的紫色與細緻的香草般甜香,不含人工色素。我們直接在菲律賓採購,並以中國為擴充規模的次要路線,於出貨前逐批檢測與記錄。",
    "applications": [
      "拿鐵與即飲飲品",
      "烘焙與麵包",
      "冰淇淋與 gelato",
  ...
  "lions-mane": {
    ...
    "intro": "猴頭菇(Hericium erinaceus)是營養補充品牌指名採用的機能性菇類。我們供應子實體粉末——而非穀物上的菌絲體——讓配方師從乾淨、有記錄的原料出發,並檢測活性成分與污染物。採購自中國,逐批檢測並於出貨前記錄,提供有機與常規等級。",
    "applications": [
      "膠囊與錠劑",
      "機能性咖啡與拿鐵",
      "益智(nootropic)配方",
  ...
  "hibiscus": {
    ...
    "intro": "洛神花(Hibiscus sabdariffa)帶來深邃的紅寶石色澤與如蔓越莓般鮮明的酸香,無論在飲品或烘焙中都表現出色。我們採購日曬成熟的花萼——主要來自埃及,並以華東為衝量路線——研磨為均勻的粉末,於出貨前逐批檢測與記錄。",
    "applications": [
      "茶飲與沖泡",
      "即飲與機能性飲品",
      "天然紅色色素",
  ...
  "jasmine-tea-powder": {
    ...
    "intro": "茉莉花茶粉是以真實茉莉花層層薰製的綠茶,再細緻研磨而成——帶來馥郁花香與純淨柔和的尾韻。我們採購自華東與福建——中國經典的茉莉花產區——並於出貨前逐批檢測與記錄。",
    "applications": [
      "拿鐵與茶吧",
      "即飲與瓶裝飲品",
      "烘焙與甜點",
  ...
  "oolong-tea-powder": {
    ...
    "intro": "烏龍是一種半發酵茶——介於綠茶與紅茶之間——帶有焙香與花香的層次。我們將來自中國經典烏龍產區的全葉烏龍研磨為細緻粉末,用於特色拿鐵、即飲與甜點製作,並於出貨前逐批檢測與記錄。",
    "applications": [
      "特色拿鐵",
      "即飲與瓶裝飲品",
      "烘焙與甜點",
  ...
  "earl-grey-tea-powder": {
    ...
    "intro": "伯爵茶是帶天然佛手柑的紅茶——濃郁、柑橘鮮明且辨識度極高。我們將它研磨為細緻粉末,把香氣帶入拿鐵、烘焙與飲品創新,採購自華東與福建,並於出貨前逐批記錄。",
    "applications": [
      "拿鐵與茶吧",
      "即飲與瓶裝飲品",
      "烘焙與甜點",
...
export const ORIGIN_INTRO_ZH: Record<string, string> = {
  "china-cn": "除了茶葉,中國更是全球最大且最具實力的機能性與特色作物產地之一——從猴頭菇及其他菇類,到紫山藥與植物粉末。就這些產品線,我們採用經驗證的中國供應,逐批檢測農藥殘留、重金屬與微生物污染,並在出貨前以 Verification Record™ 完成記錄。當一項計畫需要真正的規模化又不願失去可追溯性時,這正是我們仰賴的路線。",
  "egypt-eg": "尼羅河灌溉的埃及田野是洛神花(Hibiscus sabdariffa)的經典發源地。漫長的日照為花萼賦予深邃的紅寶石色澤與鮮明純淨的酸香。我們採購日曬成熟的埃及洛神花,研磨為均勻粉末,並於出貨前逐批檢測污染物並完成記錄——讓您取樣時所見的色澤與酸香,正是您衝量時所收到的色澤與酸香。"
};
