...
export const POSTS: InsightPost[] = [
  {
    ...
    keyFacts: [
      ...
      { label: L("Lead time", "Lieferzeit", "Plazo", "Délai", "Termin", "交期"), value: L("2–4 weeks", "2–4 Wochen", "2–4 semanas", "2–4 semaines", "2–4 tygodnie", "2–4 週") },
...

  {
    ...
    metaDescription: L(
      ...
      "Lernen Sie das Team hinter Superfoods Partners kennen — die Menschen, die die Gärten prüfen, jede Charge testen und ans Telefon gehen. Vertrauen beginnt damit zu wissen, wer Ihren Matcha beschafft.",
      "Conozca al equipo detrás de Superfoods Partners — las personas que evalúan los jardines, analizan cada lote y contestan el teléfono. La confianza empieza por saber quién abastece su matcha.",
      "Rencontrez l'équipe derrière Superfoods Partners — les personnes qui évaluent les jardins, testent chaque lot et décrochent le téléphone. La confiance commence par savoir qui source votre matcha.",
      "Poznaj zespół stojący za Superfoods Partners — ludzi, którzy oceniają ogrody, badają każdą partię i odbierają telefon. Zaufanie zaczyna się od wiedzy, kto pozyskuje twoją matchę.",
      "認識 Superfoods Partners 背後的團隊——評估茶園、檢驗每批、接聽電話的人。信任始於知道是誰為你採購抹茶。",
    ),
    dek: L(
      ...
      "Beschaffung, der Sie vertrauen, beginnt mit Menschen, die Sie beim Namen kennen. Lernen Sie das kleine, namentlich bekannte Team kennen, das die Gärten prüft, jede Charge testet und ans Telefon geht.",
      "El abastecimiento en el que puede confiar empieza con personas a las que puede nombrar. Conozca al pequeño equipo, con nombre propio, que evalúa los jardines, analiza cada lote y contesta el teléfono.",
      "Un approvisionnement digne de confiance commence par des personnes que vous pouvez nommer. Rencontrez la petite équipe identifiée qui évalue les jardins, teste chaque lot et répond au téléphone.",
      "Zaopatrzenie, któremu ufasz, zaczyna się od ludzi, których możesz wskazać z imienia. Poznaj mały, znany z imienia zespół, który ocenia ogrody, bada każdą partię i odbiera telefon.",
      "值得信任的採購，始於你叫得出名字的人。認識這支評估茶園、檢驗每批、接聽電話的具名小團隊。",
    ),
    lede: L(
      ...
      "Superfoods Partners wird von einem kleinen, namentlich bekannten Team geführt, das an unseren drei Standorten in Beschaffung, Qualitätskontrolle und Partnerschaften arbeitet. Hinter jeder Charge steht eine konkrete Person, die den Garten geprüft, das Material getestet oder Ihren Anruf entgegengenommen hat — kein anonymer Zwischenhändler.",
      "Superfoods Partners está dirigida por un equipo pequeño y con nombre propio que trabaja en abastecimiento, control de calidad y alianzas desde nuestras tres sedes. Detrás de cada lote hay una persona concreta que evaluó el jardín, analizó el material o atendió su llamada — no un intermediario anónimo.",
      "Superfoods Partners est gérée par une petite équipe identifiée qui travaille sur le sourcing, le contrôle qualité et les partenariats, depuis nos trois sites. Derrière chaque lot, il y a une personne précise qui a évalué le jardin, testé la matière ou pris votre appel — pas un courtier anonyme.",
      "Superfoods Partners jest prowadzona przez mały, znany z imienia zespół, działający w obszarze sourcingu, kontroli jakości i partnerstw w naszych trzech lokalizacjach. Za każdą partią stoi konkretna osoba, która oceniła ogród, zbadała materiał lub odebrała twój telefon — nie anonimowy pośrednik.",
      "Superfoods Partners 由一支叫得出名字的小團隊營運，橫跨採購、品質管制與合作關係，分布於我們的三個據點。每一批背後都有一位具體的人——評估茶園、檢驗材料或接聽你的電話——而非匿名的中間商。",
    ),
    sections: [
      {
    ...
    keyFacts: [
      ...
      { label: L("Based", "Sitz", "Sede", "Basée à", "Siedziba", "據點"), value: L("Three locations", "Drei Standorte", "Tres sedes", "Trois sites", "Trzy lokalizacje", "三個據點") },
    ],
    faqs: [
      {
        ...
        a: L(
          ...
          "Ja. Sie arbeiten mit namentlich bekannten Menschen an unseren Standorten, nicht mit einem gesichtslosen Bestell-Desk — erreichbar innerhalb Ihres Arbeitstags.",
          "Sí. Trabaja con personas con nombre en nuestras sedes, no con un mostrador de pedidos anónimo — accesibles dentro de su jornada laboral.",
          "Oui. Vous travaillez avec des personnes identifiées sur nos différents sites, pas un guichet de commandes anonyme — joignables pendant votre journée de travail.",
          "Tak. Współpracujesz z konkretnymi osobami w naszych lokalizacjach, a nie z anonimowym działem zamówień — dostępnymi w twoim dniu pracy.",
          "可以。你面對的是我們各據點具名的人，而非無名的接單櫃台——在你的工作時間內可聯繫。",
        ),
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: L(
          ...
          "Ja — wir prüfen und dokumentieren Farbe und Partikelgröße pro Charge, sodass die Spezifikation über Folgeaufträge konstant bleibt.",
          "Sí — controlamos y documentamos el color y el tamaño de partícula por lote, de modo que la especificación se mantiene constante en pedidos repetidos.",
          "Oui — nous contrôlons et documentons la couleur et la granulométrie par lot, de sorte que la spécification reste constante sur les commandes répétées.",
          "Tak — badamy i dokumentujemy kolor oraz wielkość cząstek dla każdej partii, więc specyfikacja pozostaje stała przy kolejnych zamówieniach.",
          "可以——我們逐批檢驗並記錄色澤與粒徑，使規格在重複訂單間維持一致。",
        ),
      },
    ],
    relatedProducts: ["ube"],
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          E("Meeting that demand at scale runs on a few concrete standards. Orders typically start at 25 kg and run to a full container, with samples first so buyers approve the material before committing. Lead times run 2–4 weeks, on FOB, CIF or DDP terms. And every batch should carry a full lab panel and documentation — the difference between a good sample and a supply you can build a product line on."),
        ],
      },
      {
