  ...
  return (
    <section className="bg-sand">
      <div className="mx-auto max-w-6xl px-6 py-16 md:py-20">
        ...
        <h2 className="mt-4 max-w-2xl display text-3xl text-green md:text-4xl">{t("heading")}</h2>
        <motion.div
        ...
        >
          {origins.map((o) => (
            ...
            >
              ...
              <span className="mono text-[9px] uppercase tracking-widest text-stone/45">{t("originLabel")} · {o.countryCode}</span>
